var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		// 获取特定div作为背景
		// particle-div是你想要将其作为背景的div的ID
		var body = document.getElementById("particle-div");
		...
		canvas.element.style = "position: absolute; top: 0; left: 0; z-index: 1000; width: 100%; height: 100%;";
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementById("particle-div").style.width;
		var height = document.getElementById("particle-div").style.height;
